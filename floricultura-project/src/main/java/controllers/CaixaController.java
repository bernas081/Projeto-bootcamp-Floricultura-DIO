...
public class CaixaController implements ICaixaController {
    ...
    @Override
    public void entradaDeSaldo(double valor, String descricao, String formaPagamento) {
        if (valor > 0) {
    ...
    @Override
    public void saidaDeSaldo(double valor, String descricao, String formaPagamento) {
